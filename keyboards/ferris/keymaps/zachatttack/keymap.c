...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TILD, KC_UNDS, KC_TRNS, KC_TRNS, KC_TRNS, 
    KC_TRNS, KC_TRNS, KC_TRNS, KC_DQT, KC_QUOT, 

    KC_DLR, KC_LBRC, KC_LPRN, KC_LCBR, KC_AMPR, 
    KC_ASTR, KC_RCBR, KC_RPRN, KC_RBRC, KC_CIRC, 

    KC_TRNS, KC_TRNS, KC_LABK, KC_EXLM, KC_TRNS, 
    KC_TRNS, KC_TRNS, KC_RABK, KC_TRNS, KC_TRNS, 
